...
def signUpAcc(email, cc, expiration, cvc, zipcode):
    ...
    signUpBottom.click()
    time.sleep(1.4)
    select = driver.find_element_by_xpath('//*[@id="plan-1"]/div/div[2]/button')
    select.click()
    #hooverMouse()
   ...
   # pyautogui.moveTo(1907, 610, duration=0.25)
    ...
    driver.find_element_by_xpath('//*[@id="email"]').send_keys("afhdjskla@yahoo.com")##anthony needs to change
